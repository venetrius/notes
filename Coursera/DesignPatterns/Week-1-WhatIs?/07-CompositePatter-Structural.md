...
## Goals
- Compose nested (tree like) structure of objects
- Deal with the classes of these object uniformly

##Structure
- Interface or abstract class describe

## How to implement
-Design interface which describe de classes
- Implement interface in composite class
- Implement interface in leaf class
